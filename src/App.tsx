...
import OeffnungszeitenDetailPage from '@/pages/OeffnungszeitenDetailPage';
import GaleriePage from '@/pages/GaleriePage';
import GalerieDetailPage from '@/pages/GalerieDetailPage';
import StandortKontaktPage from '@/pages/StandortKontaktPage';
import StandortKontaktDetailPage from '@/pages/StandortKontaktDetailPage';
// <custom:imports>
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="oeffnungszeiten/:id" element={<OeffnungszeitenDetailPage />} />
                <Route path="galerie" element={<GaleriePage />} />
                <Route path="galerie/:id" element={<GalerieDetailPage />} />
                <Route path="standort-kontakt" element={<StandortKontaktPage />} />
                <Route path="standort-kontakt/:id" element={<StandortKontaktDetailPage />} />
